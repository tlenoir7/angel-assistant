...
class AngelCore:
    ...
    def generate_reply(
        ...
        *,
        ...
        if med_cmd:
            system_prompt += (
                "\n\nTyler's message triggered the **Medical Intelligence Core** (Build 5–7: clinical DBs, biomedical parallel research, and theoretical treatment design when relevant — open sources). "
